...
public class ClockPane extends Pane {
    ...
    private void paintClock() {
        ...
        if(hourHandVisible && minuteHandVisible && secondHandVisible){
            getChildren().clear();
            getChildren().addAll(circle, t1, t2, t3, t4, sLine, mLine, hLine);
        }
        else if(hourHandVisible && minuteHandVisible){
            getChildren().clear();
            getChildren().addAll(circle, t1, t2, t3, t4, mLine, hLine);
        }
        else if(hourHandVisible && !secondHandVisible){
            getChildren().clear();
            getChildren().addAll(circle, t1, t2, t3, t4,hLine);
        }
    }
